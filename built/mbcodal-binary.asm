...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 2084 (incl. 1372 user, 660 helpers, 12 vtables, 40 lits); src size 0
; assembly: 1355 lines; density: 1372 bytes/stmt; (1 stmts)
; total bytes: 305188 (232.8% of 128.0k flash with -174116 free)
...
; start
    ...
    .hex 8AF3EA870399E962 ; hex template hash
